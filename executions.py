...
def execution_regression():
    os.system('python3 -m behave -f allure_behave.formatter:AllureFormatter -o reporte ./features/')
    
def execution_tag(tag_name):
    os.system('python3 -m behave -f allure_behave.formatter:AllureFormatter -o reporte --tags='+tag_name+' -f pretty')
