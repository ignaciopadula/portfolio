...
def combine_allure(folder):
    ...
    with open(folder + os.sep + "avla_report.html", "w", encoding="utf8") as f:
        f.write(str(soup))

    print(f"> Saving result as {folder} {os.sep}avla_report.html")

    size = os.path.getsize(folder + os.sep + 'avla_report.html')
